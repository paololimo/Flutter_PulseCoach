...
void main() {
  ...
  group('AppTextStyles', () {
    testWidgets('[P2] 1.6-UNIT-003: caption meets 11sp minimum constraint', (
      tester,
    ) async {
    ...
    testWidgets('[P2] body text size hierarchy is strictly descending', (
      tester,
    ) async {
      expect(
        AppTextStyles.display.fontSize,
        greaterThan(AppTextStyles.h1.fontSize!),
      );
      expect(
      ...
      expect(
        ...
        greaterThan(AppTextStyles.caption.fontSize!),
      );
      await tester.pump();
    });
    ...
    testWidgets(
      ...
      (tester) async {
        expect(
          AppTextStyles.countdown.fontSize,
          greaterThan(AppTextStyles.timerDisplay.fontSize!),
        );
        expect(
          AppTextStyles.timerDisplay.fontSize,
          greaterThan(AppTextStyles.timerSecondary.fontSize!),
        );
        expect(
          AppTextStyles.timerSecondary.fontSize,
          greaterThan(AppTextStyles.rpeNumbers.fontSize!),
        );
        await tester.pump();
      },
    );

    testWidgets('[P2] all text styles have non-null fontSize', (tester) async {
    ...
    testWidgets('[P2] all text styles have non-null fontFamily', (
      tester,
    ) async {
