...
// in pulse_coach/test/widget/profile_page_test.dart.
...
class MockGetProfile extends _i1.Mock implements _i3.GetProfile {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.UserProfile>> call() =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockUpdateProfile extends _i1.Mock implements _i7.UpdateProfile {
  MockUpdateProfile() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Either<_i5.Failure, void>> call(_i6.UserProfile? profile) =>
      (super.noSuchMethod(
