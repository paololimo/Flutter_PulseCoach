...
import 'package:pulse_coach/features/onboarding/presentation/widgets/onboarding_content_frame.dart';
                  ...
                  children: [
                    ...
                    _buildField(
                      ...
                      SegmentedButton<String>(
                        ...
                        onSelectionChanged: (Set<String> selection) {
                          setState(
                            () => _fitnessLevel = selection.isNotEmpty
                                ? selection.first
                                : null,
                          );
                        },
                    ...
                    _buildField(
                      ...
                      SegmentedButton<String>(
                        ...
                        onSelectionChanged: (Set<String> selection) {
                          setState(
                            () => _availableTime = selection.isNotEmpty
                                ? selection.first
                                : null,
                          );
                        },
                    ...
                    _buildField(
                      ...
                      SegmentedButton<String>(
                        ...
                        onSelectionChanged: (Set<String> selection) {
                          setState(
                            () => _physicalConstraints = selection.isNotEmpty
                                ? selection.first
                                : null,
                          );
                        },
                    ...
                    BlocBuilder<OnboardingCubit, OnboardingState>(
                      builder: (context, state) {
                        ...
                        return SizedBox(
                          ...
                          child: FilledButton(
                            onPressed: (_allSelected && !isLoading)
                                ? _onSubmit
                                : null,
